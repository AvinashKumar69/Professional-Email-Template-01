        ...
        <div className='space-y-6 py-5'>
            ...
            <div className='w-3/5 mx-auto'>
                ...
                <p className=''>
                    ...
                    <br /><br />
                    I am grateful for my time here. This position has helped me pinpoint my talents and my areas for improvement. I will use what I learned as a [Your Designation] in my future endeavors.
                    <br /><br />
                    Upon my resignation, the company still owes me [Number of Paid Leaves] of paid time off. The human resources department and I communicated this already, and they will add the equivalent payment to my final paycheck. The marketing team will take over all of my correspondence with clients and create a plan to move forward in my absence.
                    <br /><br />
            ...
            <div className='w-3/5 mx-auto'>
                ...
                <p className=''>
                    ...
                    <br /><br />
                    I am thankful for the past [Number of Years] years I have spent at [Your Company Name]. The students were respectful, and the staff was friendly. I will miss all of the people I have connected with during my employment.
                    <br /><br />
                    I accept the severance package the Management has offered me. The remaining custodians will cover my current duties until the Management finds a solution for the budget cuts.
                    <br /><br />
                    Best Regards,
                    <br />
                    [Your Name]
...
export default ForcedResignationLetter;